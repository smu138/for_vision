...
class WaterfallLayout: UICollectionViewLayout {
    ...
    private let minNumberOfColumns = 2
...
//        var numberOfColumns = WaterfallLayout.numberOfColumns(for: collectionView.frame.width)
//
//        if numberOfColumns == 1 {
//            numberOfColumns = self.minNumberOfColumns
//        }
